...
public class EFCoreCustomLogonAllBlazorApplication : BlazorApplication {
    public EFCoreCustomLogonAllBlazorApplication() {
        ...
        DatabaseVersionMismatch += EFCoreCustomLogonAllBlazorApplication_DatabaseVersionMismatch;
    }
    ...
    private void EFCoreCustomLogonAllBlazorApplication_DatabaseVersionMismatch(object sender, DatabaseVersionMismatchEventArgs e) {
#if EASYTEST
        e.Updater.Update();
        e.Handled = true;
#else
