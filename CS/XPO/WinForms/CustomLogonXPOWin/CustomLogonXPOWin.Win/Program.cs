...
static class Program {
    ...
    public static int Main(string[] args) {
        ...
        try {
            ...
            //winApplication.ObjectSpaceProviders.ForEach(p => {
            //    if(!(p is DevExpress.ExpressApp.NonPersistentObjectSpaceProvider)) {
            //        p.UpdateSchema();
            //    }
            //});
            //var os = winApplication.CreateObjectSpace(typeof(ApplicationUser));

            //new Updater(os, new Version()).UpdateDatabaseAfterUpdateSchema();
